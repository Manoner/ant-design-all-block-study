                  ...
                  routes: [
                    {
                      ...
                      name: 'articles',
                      icon: 'smile',
                      component: './list/search/ListSearch',
                      authority: ['admin'],
                    },
                    {
                      name: 'projects',
                      ...
                      component: './list/search/ListSearchProjects',
                    },
                    {
                      name: 'applications',
                      icon: 'smile',
                      path: '/list/search/applications',
                      component: './list/search/ListSearchApplications',
                    },
                  ],
                },
                {
