...
import DrawerForm from "@/pages/profile/ProfileAdvanced/components/DrawerForm";
...
class ProfileAdvanced extends Component<{ loading: boolean; profileAndProfileAdvanced: AdvancedProfileData; dispatch: Dispatch<any> },
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'profileAndProfileAdvanced/fetchAdvanced',
    });
  }
  ...
  render() {
    ...
    const {profileAndProfileAdvanced, loading} = this.props;
    const {advancedOperation1, advancedOperation2, advancedOperation3} = profileAndProfileAdvanced;
    const contentList = {
      tab1: (
        <Table
          pagination={false}
        ...
        {({isMobile}) => {
          ...
          return (
            <Fragment>
              ...
              <Button type="primary" onClick={this.showDrawer}>主操作</Button>
              <Drawer
                title="Basic Drawer"
                placement="right"
                closable={false}
...
export default connect(
  ({
     profileAndProfileAdvanced,
     loading,
   }: {
    profileAndProfileAdvanced: AdvancedProfileData;
    loading: {
      effects: { [key: string]: boolean };
    };
  }) => ({
    profileAndProfileAdvanced,
    loading: loading.effects['profileAndProfileAdvanced/fetchAdvanced'],
  }),
)(ProfileAdvanced);
