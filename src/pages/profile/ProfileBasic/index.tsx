...
interface ProfileBasicProps {
  ...
  profileAndProfileBasic: BasicProfileDataType;
}
...
> {
  componentDidMount() {
    ...
    dispatch({
      type: 'profileAndProfileBasic/fetchBasic',
    });
  }

  render() {
    const { profileAndProfileBasic, loading } = this.props;
    const { basicGoods, basicProgress } = profileAndProfileBasic;
...
export default connect(
  ({
    ...
    profileAndProfileBasic,
    loading: loading.effects['profileAndProfileBasic/fetchBasic'],
  }),
)(ProfileBasic);
